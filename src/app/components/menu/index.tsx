...
export default function MenuNav() {
  ...
  function handleMenu() {
    ...
    const closeMenuIcon = document.querySelector(".closeMenuIcon") as SVGElement
    const menuWrapper = document.querySelector(".menu-wrapper") as HTMLUListElement
  ...
  return (
    <nav className="h-[70px] p-5 bg-white shadow max-w-7xl my-0 mx-auto md:flex md:items-center md:justify-between">
